	...
	arcosin() {
		if(this.rad){
					...
					if(this.hiperbolic){
						...
						document.getElementsByTagName('input')[0].value= this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.asinh(this.AlmacenaValor )*Math.PI/180);
					}
					else{
						this.pantalla = "arcsin(" + eval(this.AlmacenaValor) + ")";
						document.getElementsByTagName('input')[0].value = this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.asin(this.AlmacenaValor)*Math.PI/180);
					}
				}
	...
	arcocosin(){
		if(this.rad){
					...
					if(this.hiperbolic){
						...
						document.getElementsByTagName('input')[0].value = this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.acosh(this.AlmacenaValor )*Math.PI/180);
					}
					else{
						this.pantalla = "arccos(" + eval(this.AlmacenaValor) + ")";
						document.getElementsByTagName('input')[0].value = this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.acos(this.AlmacenaValor )*Math.PI/180);
	...
	arcotan(){
		if(this.rad){
					...
					if(this.hiperbolic){
						...
						document.getElementsByTagName('input')[0].value = this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.atanh(this.AlmacenaValor )*Math.PI/180);
					}
					else{
						this.pantalla = "arctan(" + eval(this.AlmacenaValor) + ")";
						document.getElementsByTagName('input')[0].value = this.pantalla;
						this.AlmacenaValor=Number(eval(this.AlmacenaValor));
						this.AlmacenaValor = String(Math.atan(this.AlmacenaValor )*Math.PI/180);
					}
				}
				this.putSensHiperbolic();	
	}
