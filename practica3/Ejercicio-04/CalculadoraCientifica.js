...
class CalculadoraCientifica extends Calculadora {
  ...
  digitos(disp){
	...
	Doarco(){
		if(!this.arco){
			if(!this.hiperbolic){
				this.arco=true;	
				document.getElementsByTagName('input')[11].value="sin-1";
				document.getElementsByTagName('input')[12].value="cos-1";
				document.getElementsByTagName('input')[13].value="tan-1";
			}
			else{
				this.arco=true;	
				document.getElementsByTagName('input')[11].value="sinh-1";
				document.getElementsByTagName('input')[12].value="cosh-1";
				document.getElementsByTagName('input')[13].value="tanh-1";
			}
		}
	}
	pi () {
  ...
  calcularoperacion(op){
	  /*Metodo el cual se llama y dependiendo del parametro llama al metodo log() seno()...*/
