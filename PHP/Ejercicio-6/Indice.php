...
<nav >
	...
	<h2>Crear Nueva BD/ Nueva Tabla </h2>
	<input type='submit' name='crear' value= 'Crear Nueva Base de Datos'/>
	<input type='submit' name='crearT' value= 'Crear Tabla PruebasUsabilidad'/>
	</form>
</body>
</html>";
?>